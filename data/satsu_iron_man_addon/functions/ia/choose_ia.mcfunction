...
scoreboard players set @s satsu.iron.man.addon.ia.name.anim 0
execute as @s unless score @s satsu.iron.man.addon.ia.name matches 0.. run scoreboard players set @s satsu.iron.man.addon.ia.name 1
execute as @s[scores={satsu.iron.man.addon.ia.name=1}] run title @s actionbar { "translate": "ability.title.satsu.ia.name.1","color":"#ffa500" }
execute as @s[scores={satsu.iron.man.addon.ia.name=2}] run title @s actionbar { "translate": "ability.title.satsu.ia.name.2","color":"#ffb6c1" }
execute as @s[scores={satsu.iron.man.addon.ia.name=3}] run title @s actionbar { "translate": "ability.title.satsu.ia.name.3","color":"#9370db" }
execute as @s[scores={satsu.iron.man.addon.ia.name=4}] run title @s actionbar { "translate": "ability.title.satsu.ia.name.4","color":"#708090" }
execute as @s[scores={satsu.iron.man.addon.ia.name=5}] run title @s actionbar { "translate": "ability.title.satsu.ia.name.5","color":"#00bfff" }
