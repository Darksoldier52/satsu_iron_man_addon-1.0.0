...
execute as @e[type=!palladium:custom_projectile,team=enemies,distance=..30] run tag @s remove ark_enemy
execute as @e[type=!palladium:custom_projectile,tag=!not.mee.scan,distance=..30] run team leave @s
team empty enemies
